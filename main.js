...
var Particle = require("../tslib/Particle");
var Vec2 = require("../tslib/Vec2");
var manager;
var settings = {
    duration: 5,
    animate: true,
...
var particle_nbr = 1;
var ps = new Array();
for (var i = 0; i < particle_nbr; i++) {
    var p = new Particle(new Vec2(Math.random() * 215, Math.random() * 215));
    ps.push(p);
}
var sketch = function (_a) {
    var context = _a.context, width = _a.width, height = _a.height, playhead = _a.playhead;
    return function (_a) {
        var context = _a.context, width = _a.width, height = _a.height, playhead = _a.playhead;
        ...
        var start = Math.sin(playhead * Math.PI * 2) * Math.PI;
        var end = start + Math.PI / 2 + Math.sin(playhead * Math.PI * 2 + Math.PI / 2) * Math.PI * 0.4;
        var thickness = width * 0.01 + (Math.sin(playhead * Math.PI * 2) * 0.5 + 0.5) * width * 0.05;
        context.beginPath();
...
var start = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, canvasSketch(sketch, settings)];
            case 1:
                manager = _a.sent();
                return [2];
        }
...
},{"../tslib/Particle":3,"../tslib/Vec2":4,"canvas-sketch":1}],3:[function(require,module,exports){
"use strict";
